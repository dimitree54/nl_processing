...
Alex instantiates `DatabaseService(user_id="alex")`, calls `add_words()`, and gets `AddWordsResult`. Background translation creates Russian words and links.
...
**Module-Specific Dependencies** — NFR14: `asyncpg` for Neon connectivity. NFR15: `translate_word` for background translation.

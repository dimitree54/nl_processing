"""Package-local real-database helpers for database E2E tests."""
...
async def drop_all_tables(
    ...
    *,
    ...
    """Drop all remote tables used by the database E2E fixtures."""
...
async def reset_database(
    ...
    *,
    ...
    """Drop and recreate the remote schema used by database E2E tests."""

...
from tests.unit.database.conftest import FakeExtractor, FakeValidator, setup_extraction_test
...
class TestDetailedWordStoreValidationExtract:
    ...
    async def test_get_or_extract_details_validator_error_on_extraction_propagates_and_not_persisted(
        ...
        word_id, _, word = await setup_extraction_test(
            detailed_backend, extractor, payload={"invalid": "extracted_data"}
        )

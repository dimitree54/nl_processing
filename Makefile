PACKAGES = core extract_text_from_image extract_words_from_text translate_text translate_text_bidirectional translate_text_from_image translate_word extract_word_details database database_cache sampling
